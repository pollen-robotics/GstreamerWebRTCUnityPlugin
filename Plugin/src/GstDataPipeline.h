...
extern "C"
{
    ...
    void UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API RegisterICECallback(FuncCallBackICE cb);

    typedef void (*FuncCallBackSDP)(const char* message, int size);
    static FuncCallBackSDP callbackSDPInstance = nullptr;
    void UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API RegisterSDPCallback(FuncCallBackSDP cb);
    ...
    void UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API RegisterChannelServiceDataCallback(FuncCallBackChannelData cb);

    static FuncCallBackChannelData callbackChannelStateDataInstance = nullptr;
    void UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API RegisterChannelStateDataCallback(FuncCallBackChannelData cb);

    static FuncCallBackChannelData callbackChannelAuditDataInstance = nullptr;
    void UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API RegisterChannelAuditDataCallback(FuncCallBackChannelData cb);
}
