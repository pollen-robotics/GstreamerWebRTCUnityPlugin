...
static void DrawLeveledTriangle()
{
	// Draw a Leveled triangle. Note that Levels will come out differently
	// in D3D and OpenGL, for example, since they expect Level bytes
